...
Open Unity Package Manager in your project. Click **Install package from git URL**. Enter https://github.com/monolith-jaehoon/BleWinrtDll.git?path=/BleWinrtDll-UnityPackage and confirm. 
